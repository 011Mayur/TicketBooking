...
created_at,bulk_ticket_for_discount,discount_percentage,poster_image_url)
VALUES (p_title, p_artist_name, p_venue, p_event_date, p_event_time, p_ticket_price, p_total_seats,
 p_total_seats,p_is_active,p_created_at,p_bulk_ticket_for_discount,p_discount_percentage,p_poster_image_url);
