...
namespace TicketBooking.Repository.Migrations
{
    ...
    [Migration("20260728055842_CoupenCodeOnEvent")]
    partial class CoupenCodeOnEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketBooking.Repository.Entity.Event", b =>
                {
                    ...
                    b.Property<int?>("BulkTicketForDiscont")
                        .HasColumnType("int")
                        .HasColumnName("bulk_ticket_for_discont");
            ...
            modelBuilder.Entity("TicketBooking.Repository.Entity.EventCouponCode", b =>
                {
                    ...
                    b.HasIndex("CouponId")
                        .HasDatabaseName("ix_event_coupon_codes_coupon_id");
